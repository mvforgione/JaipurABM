...
import sim.engine.Steppable;
	...
	public class HHwPlumbingSmallWorldNetwork extends HHParent {
	    ...
	    public static java.util.ArrayList<HHwPlumbingSmallWorldNetwork> houseHoldAgents = new java.util.ArrayList<>();
	    ...
	    ArrayList<HHwPlumbingOriginal> acquaintances = new ArrayList<HHwPlumbingOriginal>();
	    ArrayList<HHwPlumbingOriginal> closeFriends = new ArrayList<HHwPlumbingOriginal>();
	    ArrayList<HHwPlumbingOriginal> respectedFamilyMembers = new ArrayList<HHwPlumbingOriginal>();		//An array of IDs for agents that are in this agent's network
	    
	    ArrayList<HHwPlumbingOriginal> acqAlreadySpokenTo = new ArrayList<HHwPlumbingOriginal>();
	    ArrayList<HHwPlumbingOriginal> friendsAlreadySpokenTo = new ArrayList<HHwPlumbingOriginal>();
	    ArrayList<HHwPlumbingOriginal> famAlreadySpokenTo = new ArrayList<HHwPlumbingOriginal>();
	    private double timeStepBorn;


	    public HHwPlumbingSmallWorldNetwork(){}
	    
	    public HHwPlumbingSmallWorldNetwork(int vertexNumber, double timeStep) {
	        ...
	        isConserver = HHwPlumbingSmallWorldNetwork.generateConservationStatus();
...
//	        assignAcquaintancesToAgentAtTimeStep(state.schedule.getTime());
	        ...
	        JaipurResidentialWUSmallWorldNetwork jaipurWaterUse = (JaipurResidentialWUSmallWorldNetwork) state; 
	        monthlyDemand = getThisHouseholdDemand();
			System.out.println("testing post schedule, agent " + this.vertexName + ", time step: " + state.schedule.getTime());
...
//	        calculateUtilityandUpdateConsumption();   
	    ...
	    public void assignAcquaintancesToAgentAtTimeStep(double timeStep) {
	        ...
	        List<HHwPlumbingSmallWorldNetwork> houseHoldAgentsShuffled = new ArrayList<HHwPlumbingSmallWorldNetwork>(houseHoldAgents);
	        // Shuffle this list (friends assigned to random agents)
	        Collections.shuffle(houseHoldAgentsShuffled);
	        for (HHwPlumbingSmallWorldNetwork hhFriend : houseHoldAgentsShuffled) {
	    ...
	    public void assignFamilyToAgentAtTimeStep(double timeStep){
	        ...
	        // Shuffle this list (friends assigned to random agents)
	        Collections.shuffle(houseHoldAgentsShuffled);
	        for (HHwPlumbingSmallWorldNetwork hhFam : houseHoldAgentsShuffled) {
	    ...
	    public double calculateRatiosForUtilityFxn(ArrayList<HHwPlumbingOriginal> thisList, ArrayList<HHwPlumbingOriginal> communicatedList, boolean calculatingConserver){ 
	    	//super.calculateRatiosForUtilityFxn(thisList, communicatedList, calculatingConserver);
